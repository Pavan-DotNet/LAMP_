...
namespace DataModel
{
    public partial class GmeTargetsTwb
    {
        ...
        public string? PResellerrole { get; set; }
        public string? PAccountgroup { get; set; }
        public string? PVarId { get; set; }
        public string? PDuns { get; set; }
