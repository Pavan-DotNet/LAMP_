...
namespace DataModel
{
    public partial class GmeFlaggedTwbe1
    {
        ...
        public int? TotSnShippedByQ { get; set; }
        public int? TotSnWithSvcByQ { get; set; }
        public decimal? TotNetAmtByQ { get; set; }
        public decimal? TotNetAmtWithSvcByQ { get; set; }
    }
}
