...
namespace DataModel
{
    public partial class GmeFlaggedTwbe3
    {
        ...
        public int? TotSnShippedByProd { get; set; }
        public int? TotSnWithSvcByProd { get; set; }
        public decimal? TotNetAmtByProd { get; set; }
        public decimal? TotNetAmtWithSvcByProd { get; set; }
    }
}
