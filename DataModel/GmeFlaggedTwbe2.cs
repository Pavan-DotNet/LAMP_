...
namespace DataModel
{
    public partial class GmeFlaggedTwbe2
    {
        ...
        public string GmeFlag { get; set; } = null!;
        ...
        public double? AvgDiscPerCntry { get; set; }
        public string? FiscalQuarter { get; set; }
        public string? IsPublicSector { get; set; }
        public double? EcCpiScore { get; set; }
        public double? SvcEcCpiScore { get; set; }
        public int? TotSnShippedByQcntry { get; set; }
        public int? TotSnWithSvcByQcntry { get; set; }
        public decimal? TotNetAmtByQcntry { get; set; }
        public decimal? TotNetAmtWithSvcByQcntry { get; set; }
    }
}
