...
namespace DataModel
{
    public partial class GmeDetailsDom
    {
        ...
        public string? EcGlbGroupCompare { get; set; }
        public double? EcGlbJaroScore { get; set; }
        public string? SvcGlbGroupCompare { get; set; }
        public double? SvcGlbJaroScore { get; set; }
