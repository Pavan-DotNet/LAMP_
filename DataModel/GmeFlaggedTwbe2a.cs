...
namespace DataModel
{
    public partial class GmeFlaggedTwbe2a
    {
        ...
        public int? TotSnShippedByCntry { get; set; }
        public int? TotSnWithSvcByCntry { get; set; }
        public decimal? TotNetAmtByCntry { get; set; }
        public decimal? TotNetAmtWithSvcByCntry { get; set; }
    }
}
