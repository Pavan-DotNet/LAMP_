...
namespace DataModel
{
    public partial class GmePartnerAnalyzerVw
    {
        ...
        public string PResellerrole { get; set; } = null!;
        public string PAccountgroup { get; set; } = null!;
        public string PVarId { get; set; } = null!;
        public string PDuns { get; set; } = null!;
        public string PSfdcId { get; set; } = null!;
        ...
        public string? PRefreshDataRange { get; set; }
